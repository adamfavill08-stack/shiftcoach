      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-white/90 backdrop-blur-xl rounded-2xl border border-white/90 shadow-lg p-8">
          ...
          <div className="prose prose-slate max-w-none space-y-6 text-slate-700">
            ...
            <section>
              <h2 className="text-xl font-semibold tracking-tight text-slate-900 mt-8 mb-4">1. Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold tracking-tight text-slate-900 mt-8 mb-4">2. Use License</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold tracking-tight text-slate-900 mt-8 mb-4">3. Medical Disclaimer</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold tracking-tight text-slate-900 mt-8 mb-4">4. User Responsibilities</h2>
              <p>You agree to:</p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-xl font-semibold tracking-tight text-slate-900 mt-8 mb-4">5. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold tracking-tight text-slate-900 mt-8 mb-4">6. Changes to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold tracking-tight text-slate-900 mt-8 mb-4">7. Subscriptions and Payments</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold tracking-tight text-slate-900 mt-8 mb-4">8. Service Availability</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold tracking-tight text-slate-900 mt-8 mb-4">9. Refund Policy</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold tracking-tight text-slate-900 mt-8 mb-4">10. Contact Information</h2>
              <p>
