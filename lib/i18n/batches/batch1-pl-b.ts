...
export const batch1PlB: Record<string, string> = {
  ...
  'dashboard.calories.vsBaseTarget': 'Względem celu bazowego',
  'dashboard.calories.pctFromBase': '{pct}% względem bazy',
  'dashboard.calories.seeFullBreakdown': 'Zobacz pełny rozkład',
