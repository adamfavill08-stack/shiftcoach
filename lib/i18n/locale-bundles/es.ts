...
const messages: Record<string, string> = {
    ...
    'browse.activity.manualLogSteps': 'Registrar pasos manualmente',
    'browse.activity.manualLogStepsHint':
      '¿El wearable aún no sincronizó? Introduce los pasos que ves en el reloj o el móvil.',
    'browse.activity.stepsSourceWearable': 'Origen: Wearable (sincronizado)',
    'browse.activity.stepsSourceManual': 'Origen: Entrada manual',
    'browse.activity.stepsSourceNone': 'Origen: Sin datos de pasos',
    'browse.activity.syncStepsAria': 'Sincronizar pasos con Health Connect',
    'browse.activity.syncStepsBusy': 'Sincronizando…',
    'browse.activity.syncStepsFailed': 'No se pudo sincronizar. Inténtalo de nuevo.',
    'browse.activity.syncStepsNeedHcPermissions':
      'Se necesitan permisos de Health Connect. Abre Ajustes y permite leer pasos a ShiftCoach.',
    'browse.activity.syncStepsSignInAgain': 'Vuelve a iniciar sesión e intenta sincronizar de nuevo.',
    'browse.activity.syncStepsRequiresApp':
      'Abre la app ShiftCoach en este teléfono para sincronizar los pasos desde Health Connect.',
    ...
    'upgrade.backToSettingsAria': 'Volver a ajustes',
    'upgrade.pageTitle': 'Pásate a Pro',
    'upgrade.trustedBy': 'Con la confianza de trabajadores por turnos en todo el mundo',
    'upgrade.bannerKicker': 'ShiftCoach Pro',
    'upgrade.bannerTitle': 'Accede por completo a tus herramientas de salud en turnos',
    'upgrade.bannerSubtitle':
      'Desbloquea análisis más profundos y funciones premium de coaching pensadas para horarios rotativos.',
    'upgrade.benefitsTitle': 'Qué desbloqueas',
    'upgrade.benefits.unlimitedHistory': 'Historial ilimitado de turnos y eventos',
    'upgrade.benefits.noAds': 'Sin anuncios',
    'upgrade.benefits.adjustedCalories': 'Calorías ajustadas',
    'upgrade.benefits.nextMealWindow': 'Ventana de la próxima comida',
    'upgrade.benefits.shiftLagInsights': 'Información sobre desfase por turnos',
    'upgrade.benefits.calorieProfileSetup': 'Configuración de calorías y perfil',
    'upgrade.benefits.allBlogArticles': 'Todos los artículos del blog',
    'upgrade.buttons.monthly': 'Pro mensual',
    'upgrade.buttons.monthlyWithPrice': 'Pro mensual',
    'upgrade.buttons.monthlyWithDynamicPrice': 'Pro mensual — {price}',
    'upgrade.buttons.annual': 'Pro anual',
    'upgrade.buttons.annualWithPrice': 'Pro anual',
    'upgrade.buttons.annualWithDynamicPrice': 'Pro anual — {price}',
    'upgrade.buttons.annualSavings': '35 % más barato que el mensual',
    'upgrade.buttons.annualSavingsDynamic': '{percent} % más barato que el mensual',
    'upgrade.buttons.restore': 'Restaurar compras',
    'upgrade.buttons.continuePurchase': 'Continuar con la compra',
    'upgrade.buttons.restorePurchasesLink': 'Restaurar compras',
    'upgrade.buttons.processing': 'Procesando…',
    'upgrade.buttons.restoring': 'Restaurando…',
    'upgrade.planCard.monthlyTitle': 'Pro mensual',
    'upgrade.planCard.monthlySubtitle': 'Acceso Pro completo',
    'upgrade.planCard.yearlyTitle': 'Pro anual',
    'upgrade.planCard.yearlySubtitle': 'Mejor relación calidad-precio',
    'upgrade.planCard.perMonth': 'Al mes',
    'upgrade.planCard.perYear': 'Al año',
    'upgrade.planCard.saveBadge': 'Ahorra un {percent} %',
    'upgrade.planCard.saveBadgeStatic': 'Ahorra un 35 %',
    'upgrade.alreadyPro.title': 'Ya tienes Pro.',
    'upgrade.alreadyPro.message': 'Todas las funciones premium están desbloqueadas en tu cuenta.',
    'upgrade.purchasesUnavailable': 'Las compras están disponibles en la app móvil de ShiftCoach.',

    'subscription.upgradeCard.cta': 'Pásate a Pro',
    'subscription.upgradeCard.supporting':
      'Pásate a Pro para una experiencia sin anuncios y acceso completo a las funciones.',
    ...
    'detail.wearablesSetup.benefit3':
      'Mejores señales de movimiento y recuperación en el panel cuando hay datos reales de turnos, sueño y actividad.',
    ...
    'detail.wearablesSetup.notConnectedWhy':
      'ShiftCoach necesita permiso para leer Pasos, Sueño y Frecuencia cardíaca desde Apple Health en el iPhone o Health Connect en Android. Los datos deben existir ya en Health Connect (Samsung Health, Google Fit u otros escritores permitidos). Si Samsung Health se queda cargando, usa Google Fit hacia Health Connect como alternativa: ver las secciones de ayuda arriba.',
