          ...
          >
            ...
            >
              ...
              <li>
                ...
                <span className="font-semibold">“Sync wearables”</span>              </li>
            </ol>
            <p className="text-xs" style={{ color: "var(--text-soft)" }}>
              {t("detail.wearablesSetup.samsungDone")}
            </p>
            <p className="text-xs rounded-lg border border-slate-200 bg-slate-50/80 dark:bg-slate-800/50 dark:border-slate-700 px-3 py-2" style={{ color: "var(--text-main)" }}>
              {t("detail.wearablesSetup.samsungViaGoogleFit")}
            </p>
          </section>
        )}

        {/* Samsung / Android section (duplicate) */}
        {choice === "samsung" && (
          <section
            className="rounded-3xl backdrop-blur-2xl border px-5 py-5 flex flex-col gap-3"
            style={{
